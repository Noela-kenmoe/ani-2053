#  Résultat de la contruction complète a froid après avoir nettoyer
```cpp
╔══════════════════════════════════════════════════════════════════╗
║                                                                  ║
║                ██╗███████╗███╗   ██╗ ██████╗  █████╗             ║
...
════════════════════════════════════════════════════════════════════════════════
```
# le temps de cette construction est de : 49.18s

# le resultat de la construction complète a froid 
```cpp
╔══════════════════════════════════════════════════════════════════╗
║                                                                  ║
║                ██╗███████╗███╗   ██╗ ██████╗  █████╗             ║
...
(venv) PS C:\Users\NOELA\Desktop\Nkentseu> jenga build --target NKMath
...
════════════════════════════════════════════════════════════════════════════════
```
# le temps de cette construction est : 2.55s

# le résultat de la construction après modification d'un seul fichier source
```cpp
╔══════════════════════════════════════════════════════════════════╗
║                                                                  ║
║                ██╗███████╗███╗   ██╗ ██████╗  █████╗             ║
...
ℹ Found 12 source file(s)
✓   [12/12] Compiled: NkFunctions.cpp
ℹ Linking...
✓ Built: Build\Lib\Debug-Windows\NKMath.lib
...
════════════════════════════════════════════════════════════════════════════════
```
# le temps est de : 2.98s
# le résultat après la construction après modification d'un seul en-tête
```cpp
╔══════════════════════════════════════════════════════════════════╗
║                                                                  ║
║                ██╗███████╗███╗   ██╗ ██████╗  █████╗             ║
...
ℹ Found 12 source file(s)
✓   [8/12] Compiled: NkEulerAngle.cpp
✓   [9/12] Compiled: NkMat.cpp
✓   [10/12] Compiled: NkColor.cpp
✓   [11/12] Compiled: NkQuat.cpp
✓   [12/12] Compiled: NkRandom.cpp
ℹ Linking...
✓ Built: Build\Lib\Debug-Windows\NKMath.lib

┌──────────────────────────────────────────────────────────────────────────────────────────────┐
│  ✓ Build Successful                                                             Time: 6.41s  │
└──────────────────────────────────────────────────────────────────────────────────────────────┘
...
```
# le temps est de : 7.30s 
# Remarques : comme les fichiers d'en-tete sont inclus via **#include** tous les fichiers sources (.c,cpp) qui dépendent de cet en-tet seront automatiquement recompilés et le temps de compilation est nettement plus long que pour la modification d'un seul fichier source
