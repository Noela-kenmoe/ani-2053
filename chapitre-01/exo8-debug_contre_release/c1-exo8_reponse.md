# la taille et le temps de compilation dans la configuration debug est
**temps**: 1.91s,

**taille** : 16,8 Mo (17 643 923 octets)
...
✓   [1/1] Compiled: main.cpp
ℹ Linking...
✓ Built: Build\Lib\Release-Windows\MonEssai\MonEssai.lib
...
✓   [1/1] Compiled: app.cpp
ℹ Linking...
✓ Built: Build\Bin\Release-Windows\App\App.exe
